...
Plan.create(type: "basic", patient_id: mark.id, doctor_id: jeff.id)
Plan.create(type: "basic", patient_id: albert.id, doctor_id: ken.id)
Plan.create(type: "premium", patient_id: peter.id, doctor_id: amy.id)
Plan.create(type: "premium", patient_id: lisa.id, doctor_id: alison.id)
Plan.create(type: "basic", patient_id: amanda.id, doctor_id: robert.id)
Plan.create(type: "premium", patient_id: amanda.id, doctor_id: amy.id)
Plan.create(type: "premium", patient_id: peter.id, doctor_id: jeff.id)
Plan.create(type: "basic", patient_id: mark.id, doctor_id: ken.id)
